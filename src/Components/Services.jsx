    ...
    return (
        <>
            ...
            <div className="bg-[#FFFFF5]">
                <div id="services" className="container border-b border-gray-200 pt-28 pb-28 lg:px-16 md:px-16 px-4">
                ...
                {/* 2nd Section */}
                <div className="bg-[#FFFFF5]">
                    <div id="about" className="container pt-28 pb-28 lg:px-16 md:px-16 px-4">
