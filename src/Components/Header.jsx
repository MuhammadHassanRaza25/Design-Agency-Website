...
function Header() {
  ...
  return (
    <>
      {/* Header Bar */}
      <header id="home" className="sticky top-0 z-50 w-full bg-black">
        <div className="container Header flex items-center justify-between bg-black py-5 lg:px-16 px-5 relative">
        ...
        <div
          className={`lg:hidden bg-black px-6 overflow-hidden transition-all duration-300 ease-in-out ${menuOpen ? "max-h-96 opacity-100 py-4" : "max-h-0 opacity-0"
            }`}
        >
